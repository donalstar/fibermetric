...
public class PartTable implements DataBaseTable {
    ...
    public static final String TABLE_JOIN_PERSON_PART_TABLE =
            PartTable.TABLE_NAME + " " + PartTable.TABLE_NAME + " " +
                    ...
                    + " ON " + PartTable.TABLE_NAME + "." + PartTable.Columns._ID + " = "
                    + PersonPartTable.TABLE_NAME
    ...
    static {
        PROJECTION_MAP.put(PartTable.TABLE_NAME + "." + PartTable.Columns._ID, PartTable.Columns._ID);
        PROJECTION_MAP.put(PartTable.TABLE_NAME + "." + PartTable.Columns.NAME, PartTable.Columns.NAME);
        PROJECTION_MAP.put(PartTable.Columns.STATUS, PartTable.Columns.STATUS);
        PROJECTION_MAP.put(PartTable.Columns.SERIAL, PartTable.Columns.SERIAL);
        PROJECTION_MAP.put(PartTable.Columns.MANUFACTURER, PartTable.Columns.MANUFACTURER);
        PROJECTION_MAP.put(PartTable.Columns.MODEL_NUMBER, PartTable.Columns.MODEL_NUMBER);
        PROJECTION_MAP.put(PartTable.Columns.BARCODE, PartTable.Columns.BARCODE);
        PROJECTION_MAP.put(PartTable.Columns.BLE_ADDRESS, PartTable.Columns.BLE_ADDRESS);
        PROJECTION_MAP.put(PartTable.Columns.BLE_IN_RANGE, PartTable.Columns.BLE_IN_RANGE);
        PROJECTION_MAP.put(PartTable.Columns.OWNER, PartTable.Columns.OWNER);
        PROJECTION_MAP.put(PartTable.Columns.PICKED_UP_DATE_TS, PartTable.Columns.PICKED_UP_DATE_TS);
        PROJECTION_MAP.put(PartTable.Columns.CONDITION, PartTable.Columns.CONDITION);
        PROJECTION_MAP.put(PartTable.Columns.SITE_ID, PartTable.Columns.SITE_ID);
        PROJECTION_MAP.put(PartTable.Columns.LATITUDE, PartTable.Columns.LATITUDE);
        PROJECTION_MAP.put(PartTable.Columns.LONGITUDE, PartTable.Columns.LONGITUDE);
        PROJECTION_MAP.put(PartTable.TABLE_NAME + "." + PartTable.Columns.DESCRIPTION, PartTable.Columns.DESCRIPTION);
        PROJECTION_MAP.put(PartTable.Columns.CATEGORY, PartTable.Columns.CATEGORY);
    }
