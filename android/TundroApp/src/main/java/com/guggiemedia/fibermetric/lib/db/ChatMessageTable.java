...
public class ChatMessageTable implements DataBaseTable {
    ...
    static {
        PROJECTION_MAP.put(ChatMessageTable.TABLE_NAME + "." + ChatMessageTable.Columns._ID, ChatMessageTable.Columns._ID);
        PROJECTION_MAP.put(ChatMessageTable.Columns.MESSAGE, ChatMessageTable.Columns.MESSAGE);
        PROJECTION_MAP.put(ChatTable.Columns.PARTICIPANT, ChatTable.Columns.PARTICIPANT);
        PROJECTION_MAP.put(ChatMessageTable.Columns.MESSAGE_TIME, ChatMessageTable.Columns.MESSAGE_TIME);
        PROJECTION_MAP.put(ChatMessageTable.Columns.MESSAGE_TIME_MS, ChatMessageTable.Columns.MESSAGE_TIME_MS);
        PROJECTION_MAP.put(ChatMessageTable.TABLE_NAME + "." + ChatMessageTable.Columns.TYPE, ChatMessageTable.Columns.TYPE);
        PROJECTION_MAP.put(ChatMessageTable.Columns.CHAT_ID, ChatMessageTable.Columns.CHAT_ID);
