...
public class CommandFacade {
     ...
     * @return
     */
    public static TurnByTurnDirectionsModel turnByTurnDirectionsForLocation(Double[] location, Context androidContext) {
        TurnByTurnDirectionsCtx ctx = (TurnByTurnDirectionsCtx) ContextFactory.factory(CommandEnum.TURN_BY_TURN_DIRECTIONS, androidContext);

        ctx.setJobSiteLocation(location);

        CommandFactory.execute(ctx);

        return ctx.getInstructionSet();
    }
