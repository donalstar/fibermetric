...
public class InventoryPagerFragment extends Fragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        _viewType = InventoryPagerFragment.ViewType.getForValue(
                ...
                switch (imageId) {
                    case R.drawable.ic_beacon: {
                        ...
                        MainActivityFragmentEnum parent
                                = _viewType.equals(InventoryPagerFragment.ViewType.myInventory)
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.home:
                if (_viewType.equals(InventoryPagerFragment.ViewType.myInventory)) {
