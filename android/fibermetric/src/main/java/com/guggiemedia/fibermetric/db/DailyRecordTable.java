 ...
 *
 */
public class DailyRecordTable implements DataBaseTable {
    public static final String TABLE_NAME = "daily_record";
    ...
    public static final String DEFAULT_SORT_ORDER = DailyRecordTable.TABLE_NAME + "." + Columns.DATE + " ASC";
    ...
    public static final String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME + " ("
            ...
            + Columns.DISPLAY_DATE + " DATE NOT NULL"
            + ");";
    ...
    static {
        ...
        PROJECTION_MAP.put(Columns.DISPLAY_DATE, Columns.DISPLAY_DATE);
    }
    ...
    public String[] getDefaultProjection() {
        Set<String> keySet = DailyRecordTable.PROJECTION_MAP.keySet();
