...
public class ImageTable implements DataBaseTable {
    ...
    static {
        ...
        PROJECTION_MAP.put(Columns.CREATE_TIME, Columns.CREATE_TIME);
        PROJECTION_MAP.put(Columns.CREATE_TIME_MS, Columns.CREATE_TIME_MS);
        PROJECTION_MAP.put(Columns.FILE_NAME, Columns.FILE_NAME);
    }
